...
class simplynet_v3(nn.Module):
    
    def __init__(self):
        super(simplynet_v3,self).__init__()
...
class simplynet_v5(nn.Module):
    
    def __init__(self):
        super(simplynet_v5,self).__init__()
        ...
        # layer11, 256*3*5 --> 512*3*5
        self.conv11=nn.Conv2d(256,512,kernel_size=3,padding=1)
        # maxpool, 512*3*5 --> 512*2*3
        self.pool11=nn.MaxPool2d(2,2,padding=[1,1])
        
        # layer12, 3072 --> 1000
        self.line12=nn.Linear(3072,1000,bias=True)
        
        # layer13, 1000 --> 1000
        self.line13=nn.Linear(1000,1000,bias=True)
        
        # layer14, 1000 --> 80
        self.line14=nn.Linear(1000,80,bias=True)
